$(document).ready(function() {
	...
	function ponerBienvenida() {
		if (bienvenidaMostrada) {
			...
			h1.innerHTML = "PARQUE DE ATRACCIONES";
			h2.innerHTML = "¡Tematizado en SEGOVIA!";
			h1.setAttribute("id", "bienvenida");
			h2.setAttribute("id", "bienvenida");
			img.setAttribute("id", "imgBienvenida");
			img.setAttribute("src", "../resources/header-bg.jpg");
			DOMBienvenida.append(h1);
			DOMBienvenida.append(h2);
	...
	function ponerSugerencia(){
		if(sugerenciasMostradas){
			...
			nombreUsuario.setAttribute("for", "username");
			...
			parrafo1.append(datosNombreUsuario)
	...
	$("#enviarSugerencia").on("click", (event) =>{
		...
		console.log("fjidghisr");
		//console.log(datosNombreUsuario)
	})
